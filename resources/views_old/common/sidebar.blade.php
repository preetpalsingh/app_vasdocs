...
@endif
<!-- custom redirect for union from admin panel access -->
@if ( Auth::user()->hasRole('Union') )
<script>window.location = "{{ Config::get('app.url') }}";</script>
@endif
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="sidebar-brand-icon rotate-n-15">
			...
			<img src="{{asset('/admin/img/admin-chrome.png')}}" width="50px">
        </div>
    ...
    @if ( Auth::user()->hasRole('Simcard Vendor') )

    <!-- Divider -->
    <hr class="sidebar-divider d-none d-md-block">

    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.orderSVL') }}" >
        <i class="fas fa-calendar"></i>
            <span>Orders Management <br>รายการคำสั่งซื้อ</span>
        </a>
    </li>
