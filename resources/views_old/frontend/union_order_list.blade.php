...
.table .btn {
    padding: 0.30rem .68rem !important;
}
...
<div class="card mb-4">
                <div class="card-body" style="min-height: 600px;">
                    ...
                    <div class="row">
                        <!-- Grid column -->
                        <div class="col-md-12">
                            <h2 class="py-3 text-center font-bold font-up black-text">{{$title_main}} <br><span style="font-size:16px;">{{$title}}</span></h2>
                        </div>
                        <!-- Grid column -->
                    </div>
                        ...
                        @foreach ($data as $key => $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary m-2 view_order_item_list" data-toggle="tooltip" title="แสดงข้อมูลคำสั่งซื้อ และสร้าง PO" data-user='<?php echo json_encode($row);?>' data-id="{{ $row->id }}"><i aria-hidden="true" class="fa fa-eye"></i></a>

                                    <a href="{{ route('union.vieworderUQF', ['order_id' => $row->id]) }}" target="_blank" data-id="{{ $row->id }}" class="btn btn-warning m-2 " data-toggle="tooltip" data-original-title="ดูเอกสารสั่งซื้อจากสหกรณ์"><i class="fas fa-print"></i></a>

                                    <a  target="_blank" data-id="{{ $row->id }}" data-file="{{ $row->file }}" class="btn btn-success m-2 sp_upload_order_document" data-toggle="tooltip" data-original-title="Upload Signed Document"><i class="fas fa-cloud-upload-alt"></i></a>

                                    @if($row->status == '0')

                                    <a  target="_blank" id="{{ $row->id }}" data-id="{{ $row->id }}" data-file="{{ $row->file }}" class="btn btn-danger m-2 sp_cancel_order" data-toggle="tooltip" data-original-title="Cancel Order"><i class="fas fa-times-circle"></i></a>
      ...
      <script src="{{ asset('js/frontend_index.js?dd=3') }}"></script>
