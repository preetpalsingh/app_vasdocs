...
@section('content')
      <section class="frist">
	  	  				<div style="position: fixed;  bottom: 25px;  right: 15px;"><a href="https://line.me/ti/p/%40strongroot" target="_blank"><img width="80" height="80" src="/images/line-icon.png"></a></div>
            ...
            <div class="Package ">
               <div class="row">
                  ...
                  <div class="col-md-12 pt-3 ps-4 pe-4">
                     <div class="row " id="sp_load_more_container">
                            ...
                            <div class="ns-card_1">
                                ...
                                <div class="ns_card_2">
                                    <div class="row">
                                        ...
                                        <label for="lname" class="sp_simcard sp_simcard_{{ $row->id }} " data-id="{{ $row->id }}">TRUE</label><br>
										<span style="font-weight:500; color:#FF0000; font-size:14px;">*</span><span style="font-weight:500; font-size:14px;">ระบุค่าย <br> ก่อนขอใบเสนอราคา</span>
                                        </div>
                                    </div>
                                    <div class="ns_card_3">
            ...
            <div class="modal-content">
               ...
               <form class="sp_Union_Login_form">
                  ...
                  <div class="modal-header">
                     <h1 class="modal-title fs-5" id="exampleModalLabel">สหกรณ์ล๊อกอินเข้าระบบสั่งซื้อ <br> Union Login</h1>
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-horizontal">
                        ...
                        <div class="mb-3">
                           <label for="Union-name" class="col-form-label">ระบุ Email ผู้ใช้งาน</label>
                           <input type="email" class="form-control" id="email" required>
                        </div>

                        <div class="mb-3">
                           <label for="ID" class="col-form-label">รหัสผ่าน / Password</label>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-secondary btn-outline-warning" data-bs-dismiss="modal">ปิดหน้า</button>
         ...
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               ...
               <form class="sp_Union_Membership_form">
                  ...
                  <div class="modal-header">
                     <h1 class="modal-title fs-5" id="exampleModalLabel">กรุณาใส่ข้อมูลสมาชิก เพื่อใช้สำหรับออกใบเสนอราคา <br>Membership Verification</h1>
                     <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden="true" style="color: #fff !important;">×</span></button>
                  </div>
                  ...
                  <div class="modal-body">
                     ...
                     <div class="form-horizontal">
                        ...
                        <div class="mb-3">
                           <label for="Union-name" class="col-form-label">ระบุชื่อสหกรณ์ <br> Union Name</label>
                           <input type="text" class="form-control" id="union_name" required>
                        </div>

                        <div class="mb-3">
                           <label for="ID" class="col-form-label">รหัสสมาชิกสหกรณ์ <br> User ID</label>
                           <input type="text" class="form-control" id="union_member_id" required>
                        </div>

                        <div class="mb-3">
                           <label for="Union-name" class="col-form-label">ชื่อผู้ขอใบเสนอราคา</label>
                           <input class="form-control" name="to_detail" id="to_detail" required>
                        </div>

                        <div class="mb-3">
                           <label for="ID" class="col-form-label">สถานที่จัดส่ง</label>
                           <textarea class="form-control" name="main_shipping_location" id="main_shipping_location" rows="3" required></textarea>
                        </div>

                        <div class="mb-3">
                           <label for="ID" class="col-form-label">กรุณาระบุจำนวน</label>
                  ...
                  <div class="modal-footer">
                     ...
                     <button type="button" class="btn btn-secondary btn-outline-warning" data-bs-dismiss="modal">ปิดหน้า</button>
                     <button type="submit" class="btn btn-warning">ตรวจสอบและออกใบเสนอราคา</button>
