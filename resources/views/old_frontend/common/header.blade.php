               ...
               <ul class="navbar-nav  mb-2 mb-lg-0" >
                  ...
                  <li class="nav-item">
                     ...
                     @if ( Auth::check() && Auth::user()->hasRole('Union') )
                        ...
                        <li>
                           <a href="{{ route('union.createUOV') }}" class="nav-link " data-attr="Create order">สั่งซื้อสินค้า{{Auth::user()->role}}</a> 
                        </li>
                        <li>                 
                     ...
                     @else
                        <li>
                           <a class="nav-link show_Union_Login_modal" data-attr="Create order">สั่งซื้อสินค้า</a> 
                        </li>
                        <li>                 
                  ...
                  <li class="nav-item">
					 ...
					 @if ( Auth::check() && Auth::user()->hasRole('Union') )
                        <li class="nav-item">
                           <a class="nav-link" href="../STR_team.html">งานเปิดตัวโครงการฯ</a>
                        </li>
					@else
					    <li class="nav-item">
                           <a class="nav-link" href="STR_team.html">งานเปิดตัวโครงการฯ</a>
