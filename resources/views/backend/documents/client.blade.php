...
/* Rest of your existing CSS styles */
    ...
    <div class="container-fluid">
        ...
        <div class="card-body px-4 py-3">
            ...
            <div class="col-9">
                <h4 class="fw-semibold mb-8"><!-- {{$title}}s -->Add Client</h4>
        ...
        <div class="card card-body">
            ...
            <table class="table search-table align-middle text-nowrap">
                ...
                <tr class="search-items">
                    ...
                    <td>
                    <span class="usr-location" data-location="Edinburgh, UK">98249944kl</span>
                    </td>
                    <td>
                    ...
                    <div class="action-btn">
                        <a href="javascript:void(0)" class="text-info view ms-2">
                    ...
                    <div class="action-btn">
                        ...
                        <a href="javascript:void(0)" class="text-dark edit ms-2">
