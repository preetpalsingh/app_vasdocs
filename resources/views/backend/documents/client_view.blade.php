...
/* Rest of your existing CSS styles */
    ...
    <div class="container-fluid">
        ...
        <div class="card-body px-4 py-3">
            ...
            <div class="col-9">
                <h4 class="fw-semibold mb-8"><!-- {{$title}}s --> Clients View</h4>
        ...
        <div class="card card-body">
            ...
            <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                ...
                <i class="ti ti-users text-white me-1 fs-5"></i> Add Client ppp
                </a>
            </div>
            </div>
        </div>
        ...
        <div class="card card-body">
            ...
            <table class="table search-table align-middle text-nowrap">
                ...
                <tr class="search-items">
                    ...
                    <td>
                    <span class="usr-ph-no" data-phone="+91 (405) 483- 4512">24-10-1998</span>
                    </td>
                    <td>
                      <span class="usr-ph-no" data-phone="">#491998</span>
                    </td>
                     <td>
                    <div class="action-btn">
                        <a href="{{ route('admin.documents-view') }}" class="text-info view ms-2">
