        ...
        <div class="card card-body">
            <div class="row">
                ...
                <div class="col-md-8 col-xl-9 text-end d-flex justify-content-md-between  justify-content-between mt-3 mt-md-0">
                    ...
                    <a href="javascript:void(0)"  class="btn btn-info d-flex align-items-center float-start sp_reset" data-bs-toggle="tooltip" title="Reset Search" data-trigger="hover">
...
<script>
    ...
    function sp_load_records(query, page) {
        ...
        $.ajax({
            url: base_url+'/admin/client-search',
            type: 'GET',
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
