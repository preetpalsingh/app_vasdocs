            ...
            <div class="card mb-0">
                <div id="print" class="card-body p-0">
                    <div class="row pt-5 pl-5 pr-5 ">
                        ...
                        <div class="col-md-6 text-right pt-3">
                           <!--  <p class="font-weight-bold mb-1">Invoice #550</p-->
							...
							<p class="font-weight-bold mb-0">วันที่ {{substr($data['order_detail']->updated_at,0,10)}}</p>
							<p class="font-weight-bold mb-0" style="font-size:16">หมายเลขอ้างอิง (Reference No.)<br></p>
					...
					<div class="row px-5">
								...
								<div class="col-md-4">
									<p class="font-weight-bold mb-0">ที่อยู่จัดส่งหลัก : <br>{{$union_detail->first_name}}</p> 
                                    <p class="mb-0"><address>{{$union_detail->address}}</address></p>              
									<p class="mb-0">เบอร์โทร : ({{$union_detail->mobile_number}})</p>              
								...
								<div class="col-md-4">
									<p class="font-weight-bold mb-0">หมายเลขใบสั่งซิ้อ  (P.O. Number):</p>               
									<p class="mb-0"><br><b>________________</b></p>
  ...
  <div class="col-12  bg-light text-white p-5 pt-2 shadow mb-5 rounded-bottom sp_btn_container">
      ...
      <div class="row justify-content-end" style="display: flex;">
          ...
          <div class="col-2 d-flex flex-column ">
              ...
              <a href="{{ route('admin.vieworderSimVQ',['download'=>'pdf','order_id' => $data['order_id'], 'vendor_id' => $data['vendor_id'], 'product_id' => $data['product_id'], 'order_item_id' => $data['order_item_id'] ]) }}" class="btn btn-success mb-4 float-right">บันทึก PDF</a>
