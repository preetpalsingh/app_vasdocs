            ...
            <div class="card-body p-0">
                ...
                <div class="row pt-0 pl-5 pr-5 pb-5">
                    <div class="col-6">
                        ...
                        <p class="mb-0">โทร {{$user_detail->mobile_number}}</p>
                    </div>
                ...
                <div class="row px-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <p class="mb-0"><b>โทร (66)2-318-1026</b></p>
 								...
 								<div class="col-md-4">
									...
									<p class="mb-0">{{$user_detail->first_name}}</p>
									<p class="mb-0">
									<address>ที่อยู่ {{$user_detail->address}}</address>
									</p>
								</div>
                            ...
                            <div class="col-md-4">
                                <p class="font-weight-bold mb-0" style="text-align: right;">P.O. NUMBER:</p>               
                                <p class="mb-0" style="text-align: right;"><b>{{$data['order_detail']->po_number}}</b><br>
										บันทึกในระบบวันที่ <br>{{substr($data['order_detail']->created_at,0,10)}}</p>
                            </div>
