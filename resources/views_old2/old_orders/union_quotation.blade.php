        ...
        <div class="card mb-0">
            <div class="card-body p-0">
                <div class="row pt-5 pl-5 pr-5 ">
                    <div class="col-md-6">
                       <h1 class="logo_headding" style="font-size: 18px;">{{$union_detail->first_name}}</h1>
                    </div>
                    ...
                    <div class="col-md-6 text-right pt-3">
                       <!--  <p class="font-weight-bold mb-1">Invoice #550</p>
						...
						<p class="font-weight-bold mb-0" style="font-size:18">วันที่ :  {{substr($data['order_detail']->created_at,0,10)}} </p>
                    </div>
                </div>
                ...
                <div class="row pt-0 pl-5 pr-5 pb-5">
                    <div class="col-6">
                        ...
                        <p class="mb-0">{{$union_detail->mobile_number}}</p>
                    </div>
