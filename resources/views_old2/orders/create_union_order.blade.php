    ...
    <div class="col-12">
        <div class="card mb-0">
            <div class="card-body p-0">
                <div class="row pt-5 pl-5 pr-5 ">
                    <div class="col-md-6">
                        <h1 class="logo_headding" style="font-size: 18px;"></h1>
                    </div>
                ...
                <div class="row pt-0 pl-5 pr-5 pb-5">
                    <div class="col-6">
                        <p class="font-weight-bold mb-0">{{$union_detail->first_name}}<br><address>{{$union_detail->address}}</address>
						เบอร์โทรศัพท์ {{$union_detail->mobile_number}}</p>
                    </div>
                ...
                <div class="row pt-0 pb-5 pl-5 pr-5 mb-5 ml-5">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-group col-12 ns_list_no">
							<li class="border-0 py-0"><img src={{asset('images/button_add.jpg')}} width="25">กดที่ปุ่ม เพิ่มรายการสินค้า</li>
        ...
        <div class="bg-light text-white p-5 pt-2 shadow rounded-bottom sp_btn_container">
            ...
            <div class="row justify-content-end" style="display: flex;padding-top: 50px;">
              ...
              <button type="button" onclick="history.back()" class="btn btn-danger mb-0 float-right">ยกเลิก</button>
        ...
        <div class="modal-content">
            ...
            <form class="sp_form">
                ...
                <div class="modal-header">
                    <h5 class="modal-title  text-white" id="deleteModalExample">เพิ่มรายการสินค้า</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group mb-3">
                            <div class="col-md-12">
                                <label for="Phone " class="col-form-label">รายการโทรศัพท์</label>
                                <select class="form-control sp_get_stock_by_product_id" id="product_id" required>
                                    <option value="">เลือกโทรศัพท์</option>
                        ...
                        <div class="form-group mb-3">
                            <div class="col-md-12">
                                <label for="English " class="col-form-label">ค่ายซิมการ์ด</label>
                                <select class="form-control" id="simcard_id" required>
                                    <option value="">เลือกซิม</option>
                        ...
                        <div class="form-group mb-3">
                            <div class="col-md-12">
                                <label for="English " class="col-form-label">จำนวนชุด<span class="sp_show_stock text-primary"></span></label>
                        ...
                        <div class="form-group mb-3">
                            <div class="col-md-12">
                                <label for="English " class="col-form-label">ชื่อผู้รับ(อื่นๆ)</label>
                        ...
                        <div class="form-group mb-3">
                            <div class="col-md-12">
                                <label for="English " class="col-form-label">สถานที่จัดส่งพิเศษนอกเหนือจากสหกรณ์</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-outline-warning" data-bs-dismiss="modal">ยกเลิก</button>
                    <button type="submit" class="btn btn-warning" id="sp_add_item">เพิ่มรายการ</button>
