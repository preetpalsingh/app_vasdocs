            ...
            <div class="col-md-9 border-right">
                ...
                <div class="p-3 py-5">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-4">
                                <label class="labels">First Name<br>ชื่อจริง</label>
                            ...
                            <div class="col-md-4">
                                <label class="labels">Last Name<br>นามสกุล</label>
                            ...
                            <div class="col-md-4">
                                <label class="labels">Mobile Number<br>เบอร์โทรศัพท์</label>
                            ...
                            <div class="col-sm-6 col-md-12 mb-3 mt-3 mb-sm-0">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Address" 
                                    name="address" 
                                    value="" style="min-height: 75px !important;">{{ old('address') ? old('address') : auth()->user()->address }}</textarea>
