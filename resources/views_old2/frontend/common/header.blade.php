               ...
               <ul class="navbar-nav  mb-2 mb-lg-0" >
                  ...
                  <li class="nav-item">
                     ...
                     @if ( Auth::check() && Auth::user()->hasRole('Union') )
                        ...
                        <li>                 
                           <a href="{{ route('union.unionOL') }}" class="nav-link " >สถานะคำสั่งซื้อ</a>
                        </li>
                        <li>                 
                           <a href="{{ route('union.unionOH') }}" class="nav-link" >ประวัติการสั่งซื้อ</a>
                        </li>
                        

                     @else
                        <li>
                           <a class="nav-link show_Union_Login_modal" data-url="{{ route('union.createUOV') }}">สั่งซื้อสินค้า</a> 
                        </li>
                        <li>                 
                           <a class="nav-link show_Union_Login_modal " data-url="{{ route('union.unionOL') }}">สถานะคำสั่งซื้อ</a>
                        </li>
                        <li>                 
                           <a class="nav-link show_Union_Login_modal" data-url="{{ route('union.unionOH') }}">ประวัติการสั่งซื้อ</a>
                        </li>
