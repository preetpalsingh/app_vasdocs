                ...
                <div class="card-body" style="min-height: 600px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <h2 class="py-3 text-center font-bold font-up black-text" style="font-family: 'IBM Plex Sans Thai';">{{$title_main}} <br><span style="font-size:16px;">{{$title}}</span></h2>
                            <h2 class="py-3 text-center font-bold font-up black-text"></h2>
                        </div>
                        <!-- Grid column -->
                    </div>
