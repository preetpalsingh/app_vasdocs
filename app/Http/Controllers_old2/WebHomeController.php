...
class WebHomeController extends Controller
{
    ...
    { 
        ...
        ->selectRaw('CONCAT(first_name) as fullName')->paginate(50);
     ...
     * @return \Illuminate\Http\Response
     */
    public function unionNameListWithIdAutocompleteSearch(Request $request)
    { 
        ...
        ->selectRaw('CONCAT(first_name) as fullName,id')->paginate(50);
    ...
    public function getProductWithSeacrh(Request $request)
    {
        ...
        try {
            ...
            if( !empty($seacrh) || !empty($device) ){

                $products = DB::table('products')
                ->where(function($query) use ($seacrh , $device)
                {
	...
	public function getProductBrand(Request $request)
    {
        ...
        try {
            ...
            $products = Products::where('title' , 'LIKE', '%'. $seacrh. '%')->get();
