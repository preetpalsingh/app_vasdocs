...
class UserController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ExcelImportExport $excel_import_export)
    {
     ...
     * @author Shani Singh
     */
    public function delete_old(User $user)
    {
        DB::beginTransaction();
        try {
            // Delete User
    ...
    public function export() 
    {
        ...
        $result = $this->excel_import_export->excel_export_users($user_fileds); 
